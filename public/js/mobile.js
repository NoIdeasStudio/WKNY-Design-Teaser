...
function initWork() {
    ...
    workEl.addEventListener("touchstart",startShowWork,false);
    workEl.addEventListener("touchend",stopShowWork,false);
}
...
function initBetter() {
    ...
    betterEl.addEventListener("touchstart",startBetter,false);
    betterEl.addEventListener("touchend",stopBetter,false);
}
...
function initWorse() {
    ...
    worseEl.addEventListener("touchstart",startWorse,false);
    document.body.addEventListener("touchend",stopWorse,false);
}
